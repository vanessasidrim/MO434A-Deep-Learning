...
class SvdFeatureGenerator(FeatureGenerator):
    ...
    def process(self, df):
        ...
        xHeadlineTfidfTrain, xBodyTfidfTrain = featuresTrain[0], featuresTrain[
            1]
        ...
        if n_test > 0:
            ...
            xHeadlineTfidfTest, xBodyTfidfTest = featuresTest[0], featuresTest[
                1]
        ...
        print('headline svd features of training set saved in %s' %
              outfilename_hsvd_train)
        ...
        if n_test > 0:
            ...
            print('headline svd features of test set saved in %s' %
                  outfilename_hsvd_test)
        ...
        print('body svd features of training set saved in %s' %
              outfilename_bsvd_train)
        ...
        if n_test > 0:
            ...
            print('body svd features of test set saved in %s' %
                  outfilename_bsvd_test)

        simSvd = np.asarray(map(cosine_sim, xHeadlineSvd,
                                xBodySvd))[:, np.newaxis]
        print('simSvd.shape:')
        print(simSvd.shape)
        ...
        print('svd sim. features of training set saved in %s' %
              outfilename_simsvd_train)
        ...
        if n_test > 0:
            ...
            print('svd sim. features of test set saved in %s' %
                  outfilename_simsvd_test)
